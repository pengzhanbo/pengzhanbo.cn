import{Br as e,Dn as t,Et as n,Gr as r,In as i,Pn as a,Pt as o,Rn as s,Vr as c,Vt as l,Yn as u,Zn as d,bn as f,cn as p,gn as m,gr as h,jn as g,vn as _,xn as v,yr as y}from"./common-yNp3ynXU.js";var b=m.pie,x={sections:new Map,showData:!1,config:b},S=x.sections,C=x.showData,w=structuredClone(b),T={getConfig:r(()=>structuredClone(w),`getConfig`),clear:r(()=>{S=new Map,C=x.showData,a()},`clear`),setDiagramTitle:f,getDiagramTitle:g,setAccTitle:_,getAccTitle:s,setAccDescription:t,getAccDescription:p,addSection:r(({label:e,value:t})=>{if(t<0)throw Error(`"${e}" has invalid value: ${t}. Negative values are not allowed in pie charts. All slice values must be >= 0.`);S.has(e)||(S.set(e,t),y.debug(`added new section: ${e}, with value: ${t}`))},`addSection`),getSections:r(()=>S,`getSections`),setShowData:r(e=>{C=e},`setShowData`),getShowData:r(()=>C,`getShowData`)},E=r((e,t)=>{c(e,t),t.setShowData(e.showData),e.sections.map(t.addSection)},`populateDb`),D={parse:r(async t=>{let n=await e(`pie`,t);y.debug(n),E(n,T)},`parse`)},O=r(e=>`
  .pieCircle{
