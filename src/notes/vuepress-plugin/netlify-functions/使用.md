...
```js
const { netlifyFunctionsPlugin } = require('@vuepress-plume/plugin-netlify-functions')
module.exports = {
  //...
  plugins: [
     netlifyFunctionsPlugin(),
...
const { useNetlifyFunctionsPlugin } = require('@vuepress-plume/plugin-netlify-functions')
